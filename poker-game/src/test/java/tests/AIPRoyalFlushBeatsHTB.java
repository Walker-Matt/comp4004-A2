...
public class AIPRoyalFlushBeatsHTB {
	private Player HTB;
	...
	public void AIP_has_a_royal_flush() {
	...
	public void HTB_has_a_straight_flush() {
		...
		this.HTB = new Player(this.straightFlush);
	}
